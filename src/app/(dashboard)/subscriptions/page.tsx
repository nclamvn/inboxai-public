...
const categoryColors: Record<string, string> = {
  newsletter: 'bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-gray-100',
  promotion: 'bg-amber-100 text-gray-900 dark:bg-amber-900/30 dark:text-gray-100',
  spam: 'bg-red-100 text-gray-900 dark:bg-red-900/30 dark:text-gray-100'
}
            ...
            {subscriptions.map(sub => (
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-[13px] font-medium text-red-700 dark:text-red-400 bg-red-100 dark:bg-red-500/20 rounded-lg hover:bg-red-200 dark:hover:bg-red-500/30 disabled:opacity-50 transition-colors"
                >
